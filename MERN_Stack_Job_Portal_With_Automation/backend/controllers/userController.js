...
export const updateProfile = catchAsyncErrors(async (req, res, next) => {
  const newUserData = {
    ...
    coverLetter: req.query.coverLetter,
    niches: {
      firstNiche: req.query.firstNiche,
      secondNiche: req.query.secondNiche,
      thirdNiche: req.query.thirdNiche,
    }
  };
  console.log(newUserData.name," hello2")

  const { firstNiche, secondNiche, thirdNiche } = newUserData.niches;
  console.log("ni ",newUserData.niches)

  if (
    req.user.role === "Job Seeker" &&
    (!firstNiche || !secondNiche || !thirdNiche)
  ) {
    console.log("first ",firstNiche ," second ",secondNiche)
    return next(
